...
// import logo from '../../../../public/isshabd.PNG'
...
const OrdersPages = () => {
    ...
    return (
        ...
        <div className='container mx-12 flex justify-between'>
                                    ...
                                    <tbody className=''>
                                        ...
                                        <tr >
                                            ...
                                            <div className='flex items-center gap-10'>
                                                ...
                                                <button onClick={() => handeView(order._id)} className='btn btn-primary'>View Order</button>
            ...
            {/* ---------- Right Section ----------- */}
            <div className='w-80  bg-slate-600 text-white rounded'>
